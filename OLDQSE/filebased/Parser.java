...
public class Parser {
    ...
    protected void entityExtraction() {
        ...
        System.out.println("Pre algorithm:"+memoryUsage);
        ...
        watch.stop();
        System.out.println("Post algorithm:"+Runtime.getRuntime().totalMemory());
        System.out.println("Used:"+(Runtime.getRuntime().totalMemory()-Runtime.getRuntime().freeMemory()-memoryUsage));
